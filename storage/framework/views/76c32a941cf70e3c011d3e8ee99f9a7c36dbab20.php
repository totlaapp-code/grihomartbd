...
<?php if(empty($slug)): ?>
<?php else: ?>
    <input type="text" id="stage" value="<?php echo e($slug); ?>" hidden>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        var stockinfo = $('#stockinfo').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo url('admin/stock/get'); ?>'+'/'+stage,
            deferRender: true,
            pageLength: 50,
            columns: [{
                    data: 'serial'
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/backend/content/product/stock.blade.php ENDPATH**/ ?>