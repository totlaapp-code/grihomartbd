...
<div class="px-4 pt-4 container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="<?php echo e(url('incomplete_order/Incomplete')); ?>">
                <div class="pt-1 pb-1 widget-rounded-circle card-box order bg-light">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="mt-1 mb-0 text-dark">
                                    <span id="pending" data-plugin="counterup"><?php echo e(App\Models\Incompleteorder::where('status','Incomplete')->get()->count()); ?></span>
                                </h3>
        ...
        <div class="col-md-6 col-xl-2">
            <a href="<?php echo e(url('incomplete_order/Hold')); ?>">
                <div class="pt-1 pb-1 widget-rounded-circle card-box order bg-warning">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="mt-1 mb-0 text-dark">
                                    <span id="hold" data-plugin="counterup"><?php echo e(App\Models\Incompleteorder::where('status','Hold')->get()->count()); ?></span>
                                </h3>
        ...
        <div class="col-md-6 col-xl-2">
            <a href="<?php echo e(url('incomplete_order/Done')); ?>">
                ...
                <div class="pt-1 pb-1 widget-rounded-circle card-box order bg-success">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="mt-1 mb-0 text-dark">
                                    <span id="hold" data-plugin="counterup"><?php echo e(App\Models\Incompleteorder::where('status','Done')->get()->count()); ?></span>
                                </h3>
        ...
        <div class="col-md-6 col-xl-2">
            <a href="<?php echo e(url('incomplete_order/Cancelled')); ?>">
                <div class="pt-1 pb-1 widget-rounded-circle card-box order bg-danger">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="mt-1 mb-0 text-dark">
                                    <span id="cancelled" data-plugin="counterup"><?php echo e(App\Models\Incompleteorder::where('status','Cancelled')->get()->count()); ?></span>
                                </h3>
...
<script>
    $(document).ready(function() {
        ...
        var orderinfotbl = $('#orderinfo').DataTable({
            ajax: {
                url: "<?php echo e(url('admin/incomplete_order/')); ?>" + '/' + orderstatus,
            },
            ordering: false,
            processing: true,
            serverSide: true,
        ...
        $("#status").select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?php echo e(url('admin_order/status-list')); ?>',
                processResults: function(data) {
                    var data = $.parseJSON(data);
                    return {
                        results: data
        ...
        $(document).on('click', '.btn-status', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('order/incomplete_order/status')); ?>",
                data: {
                    'status': status,
                    'id': id,
                    '_token': token
        ...
        $(document).on('click', '#checkfraud', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('admin/fraud-check-data')); ?>",
                data: {
                    'number': number,
                    '_token': token
                },
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/admin/content/order/incompleteorder.blade.php ENDPATH**/ ?>