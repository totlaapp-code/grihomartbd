...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Products
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                ...
                <div class="" style="width: 50%;float:left;">
                    <a target="_blank" href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-primary m-2"
...
<script>
    $(document).ready(function() {
        ...
        var productinfo = $('#productinfo').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo route('admin.product.data'); ?>',
                data:{
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grihomar/public_html/resources/views/backend/content/product/index.blade.php ENDPATH**/ ?>