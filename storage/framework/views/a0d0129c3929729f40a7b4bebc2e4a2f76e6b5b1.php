...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Attrvalue
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select mb-4" name="attribute_id" id="attribute_id"
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($attribute->id); ?>"><?php echo e($attribute->attribute_name); ?>
...
<script>
    $(document).ready(function() {
        ...
        var attrvalueinfo = $('#attrvalueinfo').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.attrvalue.data'); ?>',
            columns: [{
                    data: 'id'
                }, {
                    data: 'attribute_name'
        ...
        $('#AddAttrvalue').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                uploadUrl: '<?php echo e(route('admin.attrvalues.store')); ?>',
                processData: false,
                contentType: false,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/backend/content/attribute/value.blade.php ENDPATH**/ ?>