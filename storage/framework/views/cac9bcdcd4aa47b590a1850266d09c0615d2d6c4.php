...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Slider
...
<script>
    $(document).ready(function() {
        ...
        var sliderinfo = $('#sliderinfo').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.slider.data'); ?>',
            columns: [{
                    data: 'id'
                }, {
                    data: 'slider_image',
        ...
        $('#AddSlider').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                uploadUrl: '<?php echo e(route('admin.sliders.store')); ?>',
                processData: false,
                contentType: false,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/backend/content/slider/index.blade.php ENDPATH**/ ?>