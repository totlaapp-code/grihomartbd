...
<div class="row pt-2 pb-2" id="cateoryPro" style="background: white;">
    <?php $__empty_1 = true; $__currentLoopData = $subcategoryproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryproduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-6 col-md-4 col-lg-3 mb-2">
               <div class="product-micro-row">
                     <div class="product_item_inner">
                        ...
                        <?php
                            $sizesss=App\Models\Size::where('product_id',$categoryproduct->id)->first();
                        ...
                        <div class="product-text" style="padding-bottom: 4px !important;background: white;">
                            ...
                            <div class="price-box">
                                <del class="old-product-price strong-400" style="color:red">৳
                                    <?php echo e(round($categoryproduct->sizes[0]->RegularPrice)); ?></del>
                                <span
                                    class="product-price strong-600" style="color:black">৳ <?php echo e(round($categoryproduct->sizes[0]->SalePrice)); ?></span>
                            </div>
                             <div class="pro_btn">
                                  <form name="form" action="<?php echo e(url('add-to-cart')); ?>" method="POST" enctype="multipart/form-data" style="width: 100%;float: left;text-align: center;">
                                        ...
                                        <input type="text" name="product_id" value="<?php echo e($categoryproduct->id); ?>" hidden>
...
<?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/webview/content/product/subview.blade.php ENDPATH**/ ?>