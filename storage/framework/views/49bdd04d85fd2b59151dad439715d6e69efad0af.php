    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $("#webreportTable").DataTable({
                type: "get",
                ajax: {
                    url: "<?php echo e(url('admin/user/report/data')); ?>",
                    data: {
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/admin/content/report/userreport.blade.php ENDPATH**/ ?>