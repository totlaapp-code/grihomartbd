...
<!-- End Google Tag Manager (noscript) -->
                    ...
                    <ul class="inline-links d-flex justify-content-between">
                        <li class="text-center" >
                            <a href="javascript:void(0);" onclick="openNav()" class="nav-cart-box">
                                <img src="<?php echo e(asset('public/menu-bottom.png')); ?>" alt="" style="width: 25px;"><br><span style="color: black;">Category</span>
                            </a>
                        </li>
                        
                        <li class="text-center" >
                            <a class="nav-cart-box" href="tel:<?php echo e($basicinfo->phone_one); ?>">
                                <img src="<?php echo e(asset('public/phone-call.png')); ?>" alt="" style="width: 25px;"><br><span style="color: black;">Call</span>
                            </a>
                        </li>
                        
                        <?php if(Request::url() == env('APP_URL')): ?>
                            <li class="text-center" >
                                <a class="nav-cart-box d-flex" id="viewall" href="<?php echo e(url('/')); ?>">
                                    <img src="<?php echo e(asset('public/home.png')); ?>" alt="" width="25px"><br><span>Home</span>
                                </a>
                            </li>
                        <?php else: ?>
                            <li class="text-center" >
                                <a class="nav-cart-box" href="<?php echo e(url('/')); ?>">
                                    <img src="<?php echo e(asset('public/home.png')); ?>" alt="" width="25px"><br><span style="color: black;">Home</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        
                        <li class="text-center" >
                            <a href="<?php echo e(url('/checkout')); ?>" class="nav-cart-box">
                                <img src="<?php echo e(asset('public/shopping.png')); ?>" alt="" style="width: 28px;"><br><span style="color: black;">Shop</span>
                            </a>
                        </li>
                        <li class="text-center" >
                            <a class="nav-cart-box" href="<?php echo e(url('login')); ?>">
                                <img src="<?php echo e(asset('public/user.png')); ?>" alt="" style="width: 25px;"><br><span style="color: black;">Login</span>
                            </a>
                        </li>
    ...
    <div id="message">
        ...
        <a href="<?php echo e($basicinfo->messanger); ?>" target="_blank" style="position: fixed;bottom: 290px;right: 6px;z-index:1111">
            <img src="<?php echo e(asset('public/messenger.png')); ?>" style="height:60px;border-radius:50%">
        </a>
        <a href="tel:+88<?php echo e($basicinfo->wp_1); ?>" target="_blank" style="position: fixed;bottom: 220px;right: 6px;z-index:1111">
            <img src="<?php echo e(asset('public/telephone.png')); ?>" style="height:60px;border-radius:50%">
        </a>

        <a href="https://wa.me/+88<?php echo e($basicinfo->wp_1); ?>?text=I%20am%20interested" style="position: fixed;bottom: 150px;right: 6px;z-index:1111">
            <img src="<?php echo e(asset('public/whatsappns.png')); ?>" style="height:60px;border-radius:50%">
        </a>
        <!--<a href="https://wa.me/+88<?php echo e($basicinfo->wp_2); ?>?text=I%20am%20interested" target="_blank" style="position: fixed;bottom: 90px;right: 6px;z-index:1111">-->
        <!--    <img src="<?php echo e(asset('public/whatsappns.png')); ?>" style="height:60px;border-radius:50%">-->
        <!--</a>-->
    </div>

    <a href="javascript:void(0);"  onclick="showmessage()" id="showm" style="position: fixed;bottom: 70px;right: 6px;z-index:1111">
        <img src="<?php echo e(asset('public/livec-removebg-preview.png')); ?>" style="height:60px;" id="shimg">
    </a>
    <a href="javascript:void(0);" onclick="hidemessage()" id="crossm" style="position: fixed;bottom: 70px;right: 6px;z-index:1111">
        <img src="<?php echo e(asset('public/refuse.png')); ?>" style="height:60px;" id="crimg">
    </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <a href="<?php echo e(url('checkout')); ?>" class="btn btn-primary">Submit Order</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="cartcount">
        ...
        <div id="posit" type="button" onclick="checkcartview()">
            <span style="font-size: 22px;line-height: 50px;color: white;"><?php echo e(count(Cart::content())); ?></span><img src="<?php echo e(asset('public/add-to-cart.png')); ?>" style="margin-top: -18px;height: 25px;padding-right: 8px;">
        </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/webview/master.blade.php ENDPATH**/ ?>