...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>-Register
        ...
        <div class="sign-in-page m-b-10">
            <div class="row">
                ...
                <div class="card col-md-6 col-sm-8 sign-in mb-4 mt-4">
                    ...
                    <form class="register-form outer-top-xs" method="POST" action="<?php echo e(url('register')); ?>" role="form">
                        <?php echo csrf_field(); ?>
                    ...
                    <h4 class="text-center" style="margin-top: 20px;margin-bottom:20px;">
                        Already have an account? <a href="<?php echo e(url('login')); ?>" style="color:black"> <b>Login Now</b>
                        </a>
                    </h4>
                </div>
                <!-- Sign-in -->
...
<script>
    ...
    function checkunick() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(url('check/username')); ?>/" + username,
...
<?php echo $__env->make('webview.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/auth/register.blade.php ENDPATH**/ ?>