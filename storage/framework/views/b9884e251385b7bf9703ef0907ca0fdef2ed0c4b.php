...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Main Products
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                ...
                <div class="" style="width: 50%;float:left;">
                    <a target="_blank" href="<?php echo e(route('mainproducts.create')); ?>" class="btn btn-primary m-2"
                    ...
                    <div class="col-lg-3">
                        <div class="mt-4 mb-4">
                            ...
                            <select name="category_id" id="category_id" class="form-select form-select-lg mb-3"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = App\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($category->id); ?>" <?php if(Session::get('category_id')==$category->id): ?> selected <?php endif; ?>><?php echo e($category->category_name); ?></option>
...
<script>
    $(document).ready(function() {
        ...
        var productinfo = $('#productinfo').DataTable({
            ...
            pageLength: 50,
             ajax: {
                url: '<?php echo route('admin.mainproduct.data'); ?>',
                data:{
        ...
        $('#AddProduct').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                uploadUrl: '<?php echo e(route('admin.products.store')); ?>',
                processData: false,
                contentType: false,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grihomar/public_html/resources/views/backend/content/mainproduct/index.blade.php ENDPATH**/ ?>