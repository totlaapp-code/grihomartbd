...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Account
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 rounded p-4 pb-0">
                <div class="d-flex align-items-center justify-content-center mb-4">
                    <h2 class="mb-0"><?php echo e($slug); ?> Payment List</h2>
                </div>
                ...
                <?php if($slug!='Total'): ?>
                    <div class="" style="width: 50%;float:left;">
                        <a type="button" data-bs-toggle="modal" data-bs-target="#mainAccount" class="btn btn-primary m-2"
                            style="float: right"> + Add New <?php echo e($slug); ?> Payment</a>
                    </div>
                <?php endif; ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Add New <?php echo e($slug); ?> Payment</h5>
                        ...
                        <form name="form" id="AddAccount" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control" name="form">
                                    <option value="<?php echo e($slug); ?>"><?php echo e($slug); ?></option>
                                </select>
                            </div>
                            <div class="form-floating mb-3">
                                <select class="form-control" name="payment_type" requied>
                                    <option value="">Choose</option>
                                    <?php $__currentLoopData = App\Models\Paymenttype::where('status','Active')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pay->paymentTypeName); ?>"><?php echo e($pay->paymentTypeName); ?></option>
        ...
        <div class="modal fade" id="editmainAccount" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content rounded h-100">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color: red;">Edit <?php echo e($slug); ?> Payment</h5>
                        <button type="button" class="btn-dark btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        <input type="hidden" name="accountslug" id="accountslug" value="<?php echo e($slug); ?>" />
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        var accountinfo = $('#accountinfo').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('admin/account/data')); ?>"+'/'+slug,
                data: {
                    startDate: function() {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return "<img src=<?php echo e(url('/')); ?>/" + data + " height=\"40\" alt='No Image'/>";
                    }
                },
                {
                    data: 'titleinfo'
        ...
        $('#AddAccount').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(url('admin/accounts')); ?>',
                processData: false,
                contentType: false,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/backend/content/account/index.blade.php ENDPATH**/ ?>