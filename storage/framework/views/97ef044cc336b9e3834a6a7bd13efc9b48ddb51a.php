...
<div class="px-4 pt-4 container-fluid">
        ...
        <div class="card card-body"> 
            ...
            <div class="col-12 d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between d-none d-lg-flex" style="font-size: 24px;">
                    ...
                    From: &nbsp;<input type="text" style="width:200px" class="form-control datepicker" id="infodate" value="<?php echo e(date('Y-m-d')); ?>" name="infodate">
                     &nbsp;  &nbsp; &nbsp; To: &nbsp;<input type="text" style="width:200px" class="form-control datepicker" id="infodateto" value="<?php echo e(date('Y-m-d')); ?>" name="infodateto">
                </div>
            </div>
            <div class="mb-3 col-12 d-block d-lg-none">
                <div class="d-flex justify-content-between" style="font-size: 24px;">
                    ...
                    <div class="from-group">
                        <lable>From:</lable>
                        <input type="text" style="width:200px" class="form-control datepicker" id="infodate" value="<?php echo e(date('Y-m-d')); ?>" name="infodate">
                    </div>
                    <div class="from-group">
                        <lable>To:</lable>
                        <input type="text" style="width:200px" class="form-control datepicker" id="infodateto" value="<?php echo e(date('Y-m-d')); ?>" name="infodateto">
                    </div>
                </div>
            </div> 
        </div>
    </div>
    <?php if($admin->hasRole('superadmin') || $admin->hasRole('admin') || $admin->hasRole('accounts')): ?>
    <div class="mb-4 row g-4">
        <div class="card card-body">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                    <div class="ms-3">
                        ...
                        <h6 class="mb-0" id="account"><?php echo e(\App\Models\Basicinfo::first()->account_balance); ?></h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mb-4 row g-4">
        <div class="card card-body">
            <div class="row">
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/account-deposit/Courier')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/cash1.png')); ?>" style="width:50px;">
                            <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/account-deposit/Office Sale')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/money.png')); ?>" style="width:50px;">
                            <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/account-deposit/Wholesale')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/pallete.png')); ?>" style="width:50px;">
                            <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/account-deposit/Total')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/icon/income.png')); ?>" style="width:50px;">
                            <div class="ms-3">
    ...
    <div class="mb-4 row g-4">
        <div class="card card-body">
            <div class="row">
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/expense-cost/Boost Cost')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/shuttle.png')); ?>" style="width:50px;">
                            <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/expense-cost/Office Cost')); ?>">
                    <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                        <img src="<?php echo e(asset('public/expense.png')); ?>" style="width:50px;">
                        <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/expense-cost/Bank Deposit')); ?>">
                    <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                        <img src="<?php echo e(asset('public/mobile-banking.png')); ?>" style="width:50px;">
                        <div class="ms-3">
                ...
                <div class="col-sm-6 col-xl-3">
                    <a href="<?php echo e(url('admin/expense-cost/Total Cost')); ?>">
                    <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                        <img src="<?php echo e(asset('public/reduction.png')); ?>" style="width:50px;">
                        <div class="ms-3">
    ...
    <div id="ord">
        <div class="mb-4 col-12 d-flex justify-content-between">
            ...
            <div class="d-flex justify-content-between d-none d-lg-flex" style="font-size: 24px;">
                ...
                From: &nbsp;<input type="text" style="width:200px" class="form-control datepicker" id="orderdate" value="<?php echo e(date('Y-m-d')); ?>" name="orderdate">
                 &nbsp;  &nbsp; &nbsp; To: &nbsp;<input type="text" style="width:200px" class="form-control datepicker" id="orderdateto" value="<?php echo e(date('Y-m-d')); ?>" name="orderdateto">
            </div>
        </div>
        <div class="mb-3 col-12 d-block d-lg-none">
            <div class="d-flex justify-content-between" style="font-size: 24px;">
                <div class="from-group">
                    <lable>From:</lable>
                    <input type="text" style="width:200px" class="form-control datepicker" id="orderdate" value="<?php echo e(date('Y-m-d')); ?>" name="orderdate">
                </div>
                <div class="from-group">
                    <lable>To:</lable>
                    <input type="text" style="width:200px" class="form-control datepicker" id="orderdateto" value="<?php echo e(date('Y-m-d')); ?>" name="orderdateto">
                </div>
            </div>
        </div>
        <div class="mb-4 row g-4">
            <div class="card card-body">
                <div class="row">
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/orderall')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <img src="<?php echo e(asset('public/icon/order.png')); ?>" style="width:50px;">
                            <div class="ms-3">
        ...
        <div class="row g-4">
            <div class="card card-body">
                <div class="row">
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Pending')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Hold')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                                <p class="mb-2">Hold</p>
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Cancelled')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
        ...
        <div class="row g-4">
            <div class="card card-body">
                <div class="row">
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Ready to Ship')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Packaging')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-lg-3">
                        <a href="<?php echo e(url('admin_order/Shipped')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
    ...
    <div  id="print-areac">
        ...
        <div class="row">
            <div style="margin: 0;margin-top: 8px;display: flex;font-size: 24px;color: black;font-weight: bold;margin-bottom: 20px;justify-content: center;">Date: <div id="dateid"><?php echo e(date('Y-m-d')); ?></div> </div> 
        </div>
        ...
        <div class="row g-4">
            <div class="card card-body">
                <div class="row">
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Courier Pending')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-lg-3">
                        <a href="<?php echo e(url('admin_order/Completed')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Partial Delivered')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-lg-3">
                        <a href="<?php echo e(url('admin_order/Del. Failed')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                    ...
                    <div class="mb-2 col-sm-6 col-xl-3">
                        <a href="<?php echo e(url('admin_order/Unknown')); ?>">
                        <div class="p-4 rounded bg-secondary d-flex align-items-center justify-content-between">
                            <div class="ms-3">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control datepicker" id="startDates"
                                    value="<?php echo e($dateold); ?>" placeholder="Select Date">
                            </div>
                    ...
                    <form name="form" id="AddTask" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="admin_id" name="admin_id">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = App\Models\Admin::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($adm->id); ?>"><?php echo e($adm->name); ?></option>
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control datepicker" value="<?php echo e(date('Y-m-d')); ?>" name="date" min="<?php echo e(date('Y-m-d')); ?>" id="date"
                                placeholder="Date">
   ...
   <?php if($admin->hasRole('superadmin') || $admin->hasRole('store') || $admin->hasRole('accounts') || $admin->hasRole('storeassistant')  || $admin->hasRole('admin')  || $admin->hasRole('manager')): ?>
                    ...
                    <?php
                        ...
                        <?php $__currentLoopData = App\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-2 col-sm-6 col-xl-3">
                                <div class="p-4 rounded bg-white d-flex align-items-center justify-content-between">
                                    <div class="ms-3">
                                        <p class="mb-2"><?php echo e($category->category_name); ?></p>
                                        <h6 class="mb-0" id=""><?php echo e($stock); ?> pics</h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-2 col-sm-6 col-xl-3">
                            <div class="p-4 rounded bg-white d-flex align-items-center justify-content-between">
                                <div class="ms-3">
                                    <p class="mb-2">Total</p>
                                    <h6 class="mb-0" id=""><?php echo e($avtotal); ?> pics</h6>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        var taskinfo = $('#taskinfo').DataTable({
            ...
            serverSide: true,
             ajax: {
                url:'<?php echo route('task.datacourier'); ?>',
                data: {
                    startDate: function() {
    ...
    function loadinfo(){
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(url('admin/get/information')); ?>",
            data:{
                'infodate':infodate,
    ...
    function loadorder(){
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(url('admin/get/order/information')); ?>",
            data:{
                'orderdate':orderdate,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/backend/content/maincontent.blade.php ENDPATH**/ ?>