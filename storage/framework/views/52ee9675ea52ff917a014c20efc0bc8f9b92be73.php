 <?php $__empty_1 = true; $__currentLoopData = $categoryproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryproduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <?php
            ...
            <div class="product-micro-row">
                     ...
                     <div class="product_item_inner">
                        ...
                        <div class="product-text" style="padding-bottom: 4px !important;background: white;">
                            <div class="pro_name">
                             <a href="<?php echo e(url('view-product/' . $categoryproduct->ProductSlug)); ?>" id="f_pro_name"><p style="margin: 0;height: 50px;"><?php echo e($categoryproduct->ProductName); ?></p></a>
                            ...
                            <div class="price-box">
                                ...
                                <span
                                    class="product-price strong-600" style="color:black">৳ <?php echo e(round($firstcatepro->sizes[0]->SalePrice)); ?></span>
                            </div>
...
<?php endif; ?>
<?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/webview/product.blade.php ENDPATH**/ ?>