<?php $__env->startSection('maincontent'); ?>
    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="pagetitle row">
            ...
            <div class="col-6" style="text-align: right">
                <a href="<?php echo e(url('admin/purchase-create')); ?>" class="btn btn-primary btn-sm" ><span style="font-weight: bold;">+</span>  Add New Purchese</a>
            </div>
            <div class="col-3"> 
    ...
    <script>
        $(document).ready(function() {
            ...
            var purcheseinfotbl = $('#purcheseinfotbl').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo route('purchese.info'); ?>",
                    data: {
                        startDate: function() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#productID").select2({
                            ...
                            ajax: {
                                type:'GET',
                                url: '<?php echo e(url('admin_wholesale/products')); ?>',
    ...
    <?php $__env->startSection('subscript'); ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hazzamar/grihomartbd.com/resources/views/admin/content/purchase/purchase.blade.php ENDPATH**/ ?>