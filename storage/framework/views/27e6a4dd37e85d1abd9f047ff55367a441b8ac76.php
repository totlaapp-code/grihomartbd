            ...
            <div class="flex-wrap d-flex align-items-center" style="gap:10px;">
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" style="width:160px" class="form-control datepicker" id="orderdate"
                           value="<?php echo e(date('Y-m-d')); ?>" name="orderdate">
                </div>
                <div class="d-flex align-items-center">
                    <label>&nbsp;To:&nbsp;</label>
                    <input type="text" style="width:160px" class="form-control datepicker" id="orderdateto"
                           value="<?php echo e(date('Y-m-d')); ?>" name="orderdateto">
                </div>
                <div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grihomar/public_html/resources/views/backend/content/maincontent.blade.php ENDPATH**/ ?>