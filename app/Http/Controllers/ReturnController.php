...
class ReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        $suppliers = Supplier::where('id',2)->where('status', 'Active')->get();
        return view('admin.content.return.return', ['products' => $products, 'suppliers' => $suppliers]);
    }


    public function returndata(Request $request)
    {
        $purchases = Purchase::with(['purcheseproducts', 'suppliers'])->where('supplier_id',2)->get();
    ...
    public function create()
    {
        ...
        $suppliers = Supplier::where('status', 'Active')->where('id',2)->get();
        return view('admin.content.return.create', ['uniqueId' => $uniqueId, 'suppliers' => $suppliers]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $purchase->invoiceID = $request['data']['invoiceID'];
    ...
    public function edit($id)
    {
        ...
        $purchases->id = $id;
        return view('admin.content.return.edit')->with('purchase', $purchases);
    }
    ...
    public function suppliers(Request $request)
    {
        if (isset($request['q'])) {
            ...
            $suppliers = Supplier::query()->where('status', 'like', 'Active')->where('id',2)->get();
        }
        $supplier = array();
