...
class PathaoController extends Controller
{
    ...
    public function getCities()
    {
        ...
        //         $city =new City();
        //         $city->courier_id=28;
        //         $city->cityName=$c->city_name;
        //         $city->status='Active';
        //         $city->save();
        //         $zones=PathaoCourier::area()->zone($c->city_id);
        //         foreach($zones as $zn){
        //             foreach($zn as $z){
        //                 $zone =new Zone();
        //                 $zone->courier_id=28;
        //                 $zone->city_id=$city->id;
        //                 $zone->zoneName=$z->zone_name;
        //                 $zone->zoneId=$z->zone_id;
        //                 $zone->status='Active';
        //                 $zone->save();
        //                 $areas=PathaoCourier::area()->area($z->zone_id);
        //                 foreach($areas as $ar){
        //                     foreach($ar as $ars){
        //                         $area =new Area();
        //                         $area->courier_id=28;
        //                         $area->zone_id=$zone->id;
        //                         $area->areaName=$ars->area_name;
        //                         $area->areaId=$ars->area_id;
        //                         $area->status='Active';
        //                         $area->save();
        //                     }
        //                 }
