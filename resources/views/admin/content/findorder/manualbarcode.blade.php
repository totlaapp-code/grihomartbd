            ...
            <div class="col-md-8 p-4 m-2" style="background: white">
                <div class="card">
                    <div class="card-header text-center">
                        <h6 class="mt-2">QTY: <span style="font-weight:bold;">{{App\Models\Order::where('deliveryDate',date('Y-m-d'))->where('status','Shipped')->get()->count()}}</span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please input your invoice barcode and process it for Shipment</h4>
                    </div>
