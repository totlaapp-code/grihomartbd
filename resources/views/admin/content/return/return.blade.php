    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="pagetitle row">
            ...
            <div class="col-6" style="text-align: right">
                <a href="{{url('admin/return-create')}}" class="btn btn-primary btn-sm" ><span style="font-weight: bold;">+</span>  Receive New Return</a>
            </div>
            <div class="col-3"> 
            ...
            $('#EditPurchase').submit(function(e){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        swal({
                            title:"Return update successfully !",
                            icon: "success",
            ...
            $(document).on('click', '#deletePurchaseBtn', function(){
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            type:'DELETE',
                            url:'returns/'+purcheseId,

                            success: function (data) {
                                swal("Poof! Your return has been deleted!", {
                                    icon: "success",
                                });
                                purcheseinfotbl.ajax.reload();
                            },
