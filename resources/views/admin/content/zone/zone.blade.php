                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" id="AddZone" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 form-group">
                                <label for="menuName" class="mt-2 control-label">City name</label>
                                <div class="">
                            ...
                            <div class="pb-3 form-group">
                                <label for="websiteTitle" class="control-label">Delivery Charge</label>
                                <div class="webtitle">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-centered table-borderless table-hover" id="zoneinfo" width="100%">
