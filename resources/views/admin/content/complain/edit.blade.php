                    ...
                    <tbody>
                        @foreach ($order->products as $product)
                            <tr>
                                ...
                                <td>
                                    <span class="Color"> <input type="text" name="color" id="ProductColor"  value="{{ $product->color }}" style="    max-width: 60px;"><br><img src="{{asset(App\Models\Product::where('id',$product->product_id)->first()->ProductImage)}}" style="width:60px;margin-top:6px;"> </span>
                                </td>
                                <td>
                                    <span class="Size">
