                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="category_id" style="background: black;"
                                    ...
                                    @forelse ($categories as $category)
                                        <option value="{{ $category->id }}"  @if($category->id==$mainproduct->category_id) selected @endif>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="subcategory_id" style="background: black;" name="subcategory_id" >
                                    ...
                                    @if($mainproduct->subcategory_id)
                                        <option value="{{ $mainproduct->subcategory_id }}">
                                            {{ App\Models\Subcategory::where('id',$mainproduct->subcategory_id)->first()->sub_category_name }}
                                        </option>
                                        @else
