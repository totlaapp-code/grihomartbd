                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="number" name="inside_dhaka" id="inside_dhaka" class="form-control" placeholder="যেমন: 60">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group mb-3">
                                                            <label for="outside_dhaka">🗺️ ঢাকার বাইরে ডেলিভারি চার্জ (টাকা)</label>
                                                            <input type="number" name="outside_dhaka" id="outside_dhaka" class="form-control" placeholder="যেমন: 110">
                                                        </div>
                                                    </div>
                                                </div>
                                                <script>
