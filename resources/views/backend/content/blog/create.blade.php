...
<div class="container pt-4 px-4">
    <div class="row">
        ...
        <div class="col-12 p-4">
            <div class="hotel-form p-4" style="background: #dfe5ef !important">
                <h5 class="text-uppercase mt-0 mb-3 p-2" style="text-align: center;font-size: 32px;">Add Blog</h5>
                <br>
                <form name="form" method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="single-image image-holder-wrapper clearfix">
                                            <div class="image-holder placeholder">
                                                <img id="prevImage" style="height:100px;width:200px" />
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <button type="button" class="btn btn-danger d-block mb-2"
                                            ...
                                            <input type="file" name="banner" id="banner"
                                                onchange="loadFileBanner(event)" required>
                                        </button>
                                        <div class="single-image image-holder-wrapper clearfix">
                                            <div class="image-holder placeholder">
                                                <img id="prevImageBanner" style="height:100px;width:200px" />
                                                <i class="mdi mdi-folder-image"></i>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control ckeditor" id="BlogDetails" name="description" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
