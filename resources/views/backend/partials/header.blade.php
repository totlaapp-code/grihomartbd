...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    ...
    <a href="{{ url('/admin/dashboard') }}" class="navbar-brand d-flex d-lg-none ms-3">
        <img src="{{ asset(App\Models\Basicinfo::first()->logo) }}" alt="Logo" style="max-height: 40px; width: auto;">
    </a>
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0" style="top: 100%; right: 0; position: absolute; margin-top: 25px; z-index: 9999;">
